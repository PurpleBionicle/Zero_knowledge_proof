...
private:
    ...
    void set_G()
    {
        mpz_class x1("0x79BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798", 16);
        G.x = x1;
        mpz_class y1("0x483ADA7726A3C4655DA4FBFC0E1108A8FD17B448A68554199C47D08FFB10D4B8", 16);
        G.y = y1;
    }
public:
    Curve() {
